        ...
        <div className="min-h-screen" style={{ background: '#FFFFFF' }}>
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-start">
                                    ...
                                    <div className="w-full h-full flex flex-col p-3">
                                        ...
                                        <div className="flex flex-col gap-1.5 flex-1 justify-center">
                                            {template.thumb.slice(0, 3).map((b, idx) => (
                                                <div
                                                    key={idx}
                                                    style={{ width: b.w, height: '6px', background: b.bg, borderRadius: b.br }}
                                                />
                                            ))}
                                        </div>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            style={{ background: '#F8F7FF', border: '1.5px solid #2E106512' }}
                        >
                            {[
                                ...
                                <div key={s.label} className="text-center">
                                    <div className="font-black text-lg" style={{ color: '#2E1065', letterSpacing: '-0.02em' }}>
                                        {s.value}
                                    </div>
                                    <div className="text-[10px] uppercase tracking-wider mt-0.5" style={{ color: '#2E106550' }}>
                                        {s.label}
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="mb-8">
                            <h3
                                ...
                                style={{ color: '#2E1065', letterSpacing: '0.12em' }}
                            >
                                Termasuk Halaman
                            </h3>
                        ...
                        <div className="flex flex-wrap gap-2 mb-8">
                            {template.tags.map((tag) => (
                                <span
                                    key={tag}
                                    className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider"
                                    style={{ background: '#2E10650A', color: '#2E106560' }}
                                >
                                    #{tag}
                                </span>
                            ))}
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2 ml-auto w-full max-w-[180px]">
                                <button
                        ...
                        {/* Guarantee */}
                        <div className="flex items-center gap-3 text-xs" style={{ color: '#2E106560' }}>
            ...
            {related.length > 0 && (
                <section
                    ...
                    style={{ background: '#F8F7FF', borderTop: '1px solid #2E106510' }}
                >
                    <div className="max-w-6xl mx-auto">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                ...
                                <p className="text-xs" style={{ color: '#2E106550' }}>
                                    Dari kategori {template.category}
                                </p>
                            </div>
                            <Link
                                href="/templates"
                                className="text-sm font-bold flex items-center gap-1.5 px-4 py-2 rounded-full transition-all hover:opacity-80"
